...
var G__4304 = o;
(G__4304[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__4305__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__4305 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__4306__i = 0, G__4306__a = new Array(arguments.length -  0);
while (G__4306__i < G__4306__a.length) {G__4306__a[G__4306__i] = arguments[G__4306__i + 0]; ++G__4306__i;}
  args = new cljs.core.IndexedSeq(G__4306__a,0,null);
} 
return G__4305__delegate.call(this,args);};
G__4305.cljs$lang$maxFixedArity = 0;
G__4305.cljs$lang$applyTo = (function (arglist__4307){
var args = cljs.core.seq(arglist__4307);
return G__4305__delegate(args);
});
...
var G__4308 = o;
(G__4308[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__4310__i = 0, G__4310__a = new Array(arguments.length -  0);
while (G__4310__i < G__4310__a.length) {G__4310__a[G__4310__i] = arguments[G__4310__i + 0]; ++G__4310__i;}
  args = new cljs.core.IndexedSeq(G__4310__a,0,null);
} 
return G__4309__delegate.call(this,args);};
G__4309.cljs$lang$maxFixedArity = 0;
G__4309.cljs$lang$applyTo = (function (arglist__4311){
var args = cljs.core.seq(arglist__4311);
...
var G__4313 = props;
var G__4313__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4313,cljs.core.cst$kw$id,id):G__4313);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4313__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__4314){
var map__4315 = p__4314;
var map__4315__$1 = (((((!((map__4315 == null))))?(((((map__4315.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4315.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__4315):map__4315);
var props = map__4315__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4315__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__4315,map__4315__$1,props,class$){
return (function (c){
...
});})(map__4315,map__4315__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__4317){
var map__4318 = p__4317;
var map__4318__$1 = (((((!((map__4318 == null))))?(((((map__4318.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4318.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__4318):map__4318);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4318__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__4318,map__4318__$1,on_write){
return (function (){
...
});})(node_value,map__4318,map__4318__$1,on_write))
);
} else {
...
var G__4321 = jsprops;
(G__4321["defaultValue"] = value);

(G__4321["onChange"] = ((function (G__4321,v,value,on_change){
return (function (p1__4320_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__4320_SHARP_);
});})(G__4321,v,value,on_change))
);
...
var vec__4324 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4324,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4324,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4324,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___4328 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___4328 == null)){
} else {
var key_4329 = temp__5461__auto___4328;
(jsprops["key"] = key_4329);
}
...
var temp__5461__auto___4330 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___4330 == null)){
} else {
var key_4331 = temp__5461__auto___4330;
reagent.impl.template.oset(jsprops,"key",key_4331);
}
...
var G__4332 = reagent.impl.template.__GT_NativeWrapper();
(G__4332["name"] = c);
...
var G__4333 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__4333) : reagent.impl.template.as_element.call(null,G__4333));
} else {
...
var len__4730__auto___4339 = arguments.length;
var i__4731__auto___4340 = (0);
while(true){
if((i__4731__auto___4340 < len__4730__auto___4339)){
args__4736__auto__.push((arguments[i__4731__auto___4340]));

var G__4341 = (i__4731__auto___4340 + (1));
i__4731__auto___4340 = G__4341;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq4337){
var G__4338 = cljs.core.first(seq4337);
var seq4337__$1 = cljs.core.next(seq4337);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4338,seq4337__$1);
});
...
break;
default:
var G__4344 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__4344;
continue;
...
var n__4607__auto___4346 = a.length;
var i_4347 = (0);
while(true){
if((i_4347 < n__4607__auto___4346)){
(a[i_4347] = reagent.impl.template.as_element((a[i_4347])));

var G__4348 = (i_4347 + (1));
i_4347 = G__4348;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___4349 = a.length;
var i_4350 = (0);
while(true){
if((i_4350 < n__4607__auto___4349)){
var val_4351 = (a[i_4350]);
if(((cljs.core.vector_QMARK_(val_4351)) && ((reagent.impl.template.key_from_vec(val_4351) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_4350] = reagent.impl.template.as_element(val_4351));

var G__4352 = (i_4350 + (1));
i_4350 = G__4352;
continue;
} else {
}
...
var ctx = ({});
var vec__4353 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4353,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4353,(1),null);
...
var G__4356 = (cljs.core.count(argv) - first_child);
switch (G__4356) {
case (0):
...
var G__4357 = comp;
var G__4358 = jsprops;
var G__4359 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__4357,G__4358,G__4359) : reagent.impl.template.global$module$react.createElement.call(null,G__4357,G__4358,G__4359));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__4356){
