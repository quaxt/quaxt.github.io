...
if((i < len)){
var k = (ks[i]);
var G__4236 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__4237 = (i + (1));
m = G__4236;
i = G__4237;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__4238 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__4238) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__4238));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__4240 = c;
var G__4240__$1 = (((G__4240 == null))?null:G__4240.prototype);
if((G__4240__$1 == null)){
return null;
} else {
return (G__4240__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__4242 = c;
var G__4242__$1 = (((G__4242 == null))?null:G__4242.prototype);
if((G__4242__$1 == null)){
return null;
} else {
return (G__4242__$1["render"]);
}
})() == null)))));
});
...
var G__4244 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__4244) : reagent.impl.component.as_element.call(null,G__4244));
};
...
var _STAR_current_component_STAR__orig_val__4250 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__4251 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__4251;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__4250;
}});
...
var G__4252 = key;
var G__4252__$1 = (((G__4252 instanceof cljs.core.Keyword))?G__4252.fqn:null);
switch (G__4252__$1) {
...
return ((function (G__4252,G__4252__$1){
...
var c = this;
var G__4257_4259 = (c["cljsRatom"]);
if((G__4257_4259 == null)){
} else {
reagent.ratom.dispose_BANG_(G__4257_4259);
}
...
var renders_4261 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_4262 = cljs.core.first(cljs.core.vals(renders_4261));
if((cljs.core.count(renders_4261) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_4261))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_4262)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_4262], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__4260 = name;
switch (G__4260) {
case "":
...
var G__4265 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__4265) : reagent.impl.component.global$module$create_react_class.call(null,G__4265));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__4266 = fiber;
var G__4266__$1 = (((G__4266 == null))?null:(G__4266["type"]));
if((G__4266__$1 == null)){
return null;
} else {
return (G__4266__$1["displayName"]);
}
})();
var parent = (function (){var G__4267 = fiber;
if((G__4267 == null)){
return null;
} else {
return (G__4267["return"]);
}
})();
var path = (function (){var G__4268 = parent;
var G__4268__$1 = (((G__4268 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__4268) : reagent.impl.component.fiber_component_path.call(null,G__4268)));
if((G__4268__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4268__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__4270 = c;
if((G__4270 == null)){
return null;
} else {
return (G__4270["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__4271._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__4273 = c;
if((G__4273 == null)){
return null;
} else {
return (G__4273["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__4275 = c;
if((G__4275 == null)){
return null;
} else {
return G__4275._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__4277 = instance;
if((G__4277 == null)){
return null;
} else {
return (G__4277["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__4278 = instance;
if((G__4278 == null)){
return null;
} else {
return G__4278._currentElement;
}
}
})();
var name = (function (){var G__4279 = elem;
var G__4279__$1 = (((G__4279 == null))?null:(G__4279["type"]));
if((G__4279__$1 == null)){
return null;
} else {
return (G__4279__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__4281 = elem;
if((G__4281 == null)){
return null;
} else {
return (G__4281["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__4282._owner;
}
}
})();
var path = (function (){var G__4283 = owner;
var G__4283__$1 = (((G__4283 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__4283) : reagent.impl.component.component_path.call(null,G__4283)));
if((G__4283__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4283__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
return reagent.impl.util.fun_name(G__4284__$1);
}
}
})();
