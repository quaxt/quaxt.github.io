...
var G__3703 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__3703;
continue;
} else {
return ch;
...
var vec__3704 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3704,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq3707){
...
return (function() { 
var G__3712__delegate = function (rdr,_){
...
var G__3712 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__3713__i = 0, G__3713__a = new Array(arguments.length -  1);
while (G__3713__i < G__3713__a.length) {G__3713__a[G__3713__i] = arguments[G__3713__i + 1]; ++G__3713__i;}
  _ = new cljs.core.IndexedSeq(G__3713__a,0,null);
} 
return G__3712__delegate.call(this,rdr,_);};
G__3712.cljs$lang$maxFixedArity = 1;
G__3712.cljs$lang$applyTo = (function (arglist__3714){
var rdr = cljs.core.first(arglist__3714);
var _ = cljs.core.rest(arglist__3714);
return G__3712__delegate(rdr,_);
});
